...
public class MainActivity extends AccessoryActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mSeekBars.add((SeekBar) findViewById(R.id.gripper_seek_bar));
	...
	public void handlePosition1Click(View view) {
		...
		String command = getString(R.string.position_command, 0, 135, 90, -45,
				10);
		sendCommand(command);
	}
	...
	public void handlePosition2Click(View view) {
		...
		String command = getString(R.string.position_command, 45, 135, 0, -45,
				90);
		sendCommand(command);
	}
